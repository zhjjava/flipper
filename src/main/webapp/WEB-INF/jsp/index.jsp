...
<%@ taglib prefix="cvasc" tagdir="/WEB-INF/tags"%>
...
<frameset rows="73,*" cols="*" frameborder="no" border="0"
	...
	src="${ctx}/layout/loadTopPageAction.do" name="topFrame" scrolling="No"
	noresize="noresize" id="topFrame" /> <frameset cols="210,*"
	frameborder="no" border="0" framespacing="0"> <frame
	src="${ctx}/layout/loadMenuPageAction.do" scrolling="No"
	noresize="noresize" border="1" id="leftFrame" /> <frame
	src="${ctx}/layout/loadMainPageAction.do" name="mainFrame" border="0"
