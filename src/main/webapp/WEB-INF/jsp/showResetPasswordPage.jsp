...
Hello!!!
	<div class="container">
		...
		<div class="loginContainer">
			<form:form id="resetForm" name="resetForm" method="post" action="resetPassword.do" modelAttribute="sysUser"
				cssClass="form-horizontal" role="form">
				<form:errors path = "*" cssStyle="color:red"></form:errors>
				<br />
				<form:hidden path="userId"/>
				<div class="form-group">
					<label class="col-md-12 control-label" for="personalEmail">Email: </label>
					<div class="col-md-12">
						<form:input id="personalEmail" type="text" path="personalEmail"
							cssClass="form-control" size="25" placeholder="personalEmail" />
