	...
	<div class="container">
		...
		<div class="loginContainer">
			<form:form id="loginForm" name="loginForm" method="post"
				action="login.do" modelAttribute="sysUser"
				cssClass="form-horizontal" role="form">
				<form:errors cssStyle="color:red"></form:errors>
				<br />
				<div class="form-group">
					<label class="col-md-12 control-label" for="loginName">Login
						Name:</label>
					<div class="col-md-12">
				...
				<div class="form-group">
					...
					<div class="col-md-12">
						...
						<span class="forgot help-block"><a href="${ctx}/resetpassword/forgetPassword.do">Forgot
								Password?</a></span>
					</div>
				</div>
				<!-- End .form-group  -->
				...
				<div class="form-group">
					<div class="col-md-12 clearfix form-actions">
						<button type="submit" class="btn btn-info right" id="loginBtn">
							<span class="icon16 icomoon-icon-enter white"></span> Sign In
						</button>
					</div>
				</div>
				<!-- End .form-group  -->
			...
			<div>
				<a href="/hrms/signup.do">Sign up</a>
			</div>
		</div>
