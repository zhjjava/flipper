	...
	<div class="container">
		...
		<div class="loginContainer">
			...
			<form:form id="loginForm" name="loginForm" method="post"
				action="sendRequestOfResetPassword.do" modelAttribute = "sysUser" cssClass="form-horizontal" role="form">
				<form:input path="personalEmail" />
				...
				<div class="form-group">
					<div class="col-md-12 clearfix form-actions">
						<button type="submit" class="btn btn-info right" id="loginBtn">
							<span class="icon16 icomoon-icon-enter white"></span>Submit
						</button>
					</div>
				</div>
				<!-- End .form-group  -->
