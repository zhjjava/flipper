...
//			}
	...
	public String update(Model model,@ModelAttribute @Valid SysUser sysUser,BindingResult errorResult){
		...
		try {
			...
			oriSysUser.setSid(sysUser.getSid());
			...
			oriSysUser.setEntryDate(sysUser.getEntryDate());
			oriSysUser.setEduDegree(sysUser.getEduDegree());
			oriSysUser.setEduMajor(sysUser.getEduMajor());
			oriSysUser.setEduSchool(sysUser.getEduSchool());
			oriSysUser.setHomeAddr(sysUser.getHomeAddr());
			oriSysUser.setBirthDate(sysUser.getBirthDate());
			oriSysUser.setIdNumber(sysUser.getIdNumber());
			oriSysUser.setBankName(sysUser.getBankName());
			oriSysUser.setBankAccount(sysUser.getBankAccount());
			oriSysUser.setQuitDate(sysUser.getQuitDate());
